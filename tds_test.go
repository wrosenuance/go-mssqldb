...
func TestSendLoginWithFeatureExt(t *testing.T) {
	...
	login.FedAuthToken = "fedauthtoken"
	err := sendLogin(buf, login)
	if err != nil {
		t.Error("sendLogin should succeed")
	}
	ref := []byte{
		...
		0, 0, 0, 0, 0, 0, 0, 0, 108, 0, 7, 0, 122, 0, 10, 0,
		142, 0, 4, 0, 146, 0, 7, 0, 160, 0, 2, 0, 164, 0, 8, 0,
		18, 52, 86, 120, 144, 171, 180, 0, 0, 0, 180, 0, 0, 0, 0, 0,
		...
		97, 0, 109, 0, 101, 0, 180, 0, 0, 0, 108, 0, 105, 0, 98, 0,
		114, 0, 97, 0, 114, 0, 121, 0, 101, 0, 110, 0, 100, 0, 97, 0,
		116, 0, 97, 0, 98, 0, 97, 0, 115, 0, 101, 0, 2, 29, 0, 0,
